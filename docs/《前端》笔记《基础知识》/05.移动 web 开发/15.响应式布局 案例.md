...
<head>
    ...
    <link rel="stylesheet" href="sucai/18/bootstrap/css/bootstrap.min.css">
    <!-- 设计稿为 1280 的宽度， 而 Bootstrap 里面 container 宽度 最大为 1170px，因此我们需要手动改下container宽度 -->
    <link rel="stylesheet" href="sucai/18/css/index.css">
</head>
<body>
    <div class="container">
        <div class="row">
            <header class="col-md-2">
                <div class="logo">
                    <a href="#">
                        <img src="sucai/18/images/logo.png" alt="" class="hidden-xs">
            ...
            <article class="col-md-7">
                ...
                <div class="news clearfix">
                    <ul>
                        <li>
                            <a href="#">
                                <img src="sucai/18/upload/lg.png" alt="">
                                <p>阿里百秀</p>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="sucai/18/upload/1.jpg" alt="">
